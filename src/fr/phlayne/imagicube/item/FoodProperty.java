...
public enum FoodProperty {
	 ...
	 * WHITE_CHOCOLATE(Material.APPLE, 15, 7, 1.0F,
	 * "imagicube.food.chocolate_white"), BOILED_EGG(Material.APPLE, 16, 2, 0.6F,
	 * "imagicube.food.boiled_egg"), BOILED_EGG_SHELL(Material.SNOWBALL, 2, 0, 0F,
	 * "imagicube.food.boiled_egg"), ROTTEN_TOMATO(Material.SNOWBALL, 1, 0, 0F,
	 * "imagicube.food.rotten_tomato"), GRUB(Material.GOLDEN_CARROT,
	 * SpookificationSpell.GRUB_MODEL_DATA_ID, 1, 1.0F, "imagicube.grub"),
	 * LARVA(Material.GOLDEN_CARROT, SpookificationSpell.LARVA_MODEL_DATA_ID, 1,
	 * 1.0F, "imagicube.larva"), WORM(Material.GOLDEN_CARROT,
	 * SpookificationSpell.WORM_MODEL_DATA_ID, 1, 1.0F, "imagicube.worm"),
	 * RAW_FLESH(Material.BEEF,
	 * PurificationSpell.PURIFIED_ROTTEN_FLESH_MODEL_DATA_ID, 4, 0.2F,
	 * "imagicube.raw_purified_rotten_flesh"), COOKED_FLESH(Material.COOKED_BEEF,
	 * PurificationSpell.PURIFIED_ROTTEN_FLESH_MODEL_DATA_ID, 10, 0.75F,
	 * "imagicube.cooked_purified_rotten_flesh"), SPAGHETTI(Material.BEEF, 2, 1,
	 * 0.25F, "imagicube.spaghetti"), PENNE(Material.BEEF, 3, 1, 0.25F,
	 * "imagicube.penne"), FARFALLE(Material.BEEF, 4, 1, 0.25F,
	 * "imagicube.farfalle"), SHELL(Material.BEEF, 5, 1, 0.25F, "imagicube.shell"),
	 ...
	 * COOKED_CONCHIGLIE(Material.APPLE, 21, 6, 0.75F,
	 * "imagicube.cooked_conchiglie"), GROUND_WHEAT(Material.WHEAT_SEEDS, 1, 0, 0F,
	 * "imagicube.ground_wheat"), GUARDIAN_FLESH(Material.APPLE, 22, 4, 0.5F,
	 * "imagicube.guardian_flesh"), RICE(Material.APPLE, 23, 4, 0.75F,
	 * "imagicube.rice"), CHICKEN_NUGGET(Material.CHICKEN, 1, 1, 0.3F,
	 * "imagicube.chicken_nugget"), COOKED_CHICKEN_NUGGET(Material.COOKED_CHICKEN,
	 * 1, 3, 0.6F, "imagicube.cooked_chicken_nugget"), SAUSAGE(Material.PORKCHOP, 1,
	 * 2, 0.2F, "imagicube.sausage"), CHORIZO(Material.PORKCHOP, 2, 2, 0.3F,
	 * "imagicube.chorizo"), COOKED_SAUSAGE(Material.COOKED_PORKCHOP, 1, 3, 0.6F,
	 * "imagicube.cooked_sausage"), COOKED_CHORIZO(Material.COOKED_PORKCHOP, 2, 4,
	 * 0.8F, "imagicube.cooked_chorizo");
	 */
